...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb2.data';
    var REMOTE_PACKAGE_BASE = 'testwb2.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb2.data');

    };
    Module['addRunDependency']('datafile_testwb2.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "f29428f4-7423-472a-aaaa-8792c0f8a587"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5396416,
    DYNAMIC_BASE = 5396416,
    DYNAMICTOP_PTR = 153328;
...
var wasmBinaryFile = 'testwb2.wasm';
