...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb14.data';
    var REMOTE_PACKAGE_BASE = 'testwb14.data';
...
Module['FS_createPath']('/', 'fonts', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb14.data');

    };
    Module['addRunDependency']('datafile_testwb14.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/fonts/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "bce16e7f-200c-4c65-a4af-23bfd75ccd69"});
...
var wasmBinaryFile = 'testwb14.wasm';
