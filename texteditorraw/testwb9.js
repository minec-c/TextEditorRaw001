...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb9.data';
    var REMOTE_PACKAGE_BASE = 'testwb9.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb9.data');

    };
    Module['addRunDependency']('datafile_testwb9.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "23cb771a-8c8e-4ab7-adcf-e3ba0a59cde7"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5406720,
    DYNAMIC_BASE = 5406720,
    DYNAMICTOP_PTR = 163632;
...
var wasmBinaryFile = 'testwb9.wasm';
