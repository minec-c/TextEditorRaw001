...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb6.data';
    var REMOTE_PACKAGE_BASE = 'testwb6.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb6.data');

    };
    Module['addRunDependency']('datafile_testwb6.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "4a24d029-4c03-4cbd-be7e-b1c85a69a51a"});
...
var wasmBinaryFile = 'testwb6.wasm';
