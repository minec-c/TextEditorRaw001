...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb15.data';
    var REMOTE_PACKAGE_BASE = 'testwb15.data';
...
Module['FS_createPath']('/', 'fonts', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb15.data');

    };
    Module['addRunDependency']('datafile_testwb15.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/fonts/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "e006b525-fcd2-42ac-8a47-3f97af944c27"});
...
var wasmBinaryFile = 'testwb15.wasm';
