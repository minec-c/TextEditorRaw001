...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb5.data';
    var REMOTE_PACKAGE_BASE = 'testwb5.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb5.data');

    };
    Module['addRunDependency']('datafile_testwb5.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "a42c73d4-be82-42ba-88f0-040685c4d542"});
...
var wasmBinaryFile = 'testwb5.wasm';
