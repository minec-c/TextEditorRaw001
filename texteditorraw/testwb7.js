...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb7.data';
    var REMOTE_PACKAGE_BASE = 'testwb7.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb7.data');

    };
    Module['addRunDependency']('datafile_testwb7.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "e1bf8c5a-5f30-4e6e-952d-f13f6cbbd2c9"});
...
var wasmBinaryFile = 'testwb7.wasm';
