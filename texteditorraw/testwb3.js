...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb3.data';
    var REMOTE_PACKAGE_BASE = 'testwb3.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb3.data');

    };
    Module['addRunDependency']('datafile_testwb3.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "b7e41c93-a735-4996-9047-d0d325d7aef6"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5406784,
    DYNAMIC_BASE = 5406784,
    DYNAMICTOP_PTR = 163696;
...
var wasmBinaryFile = 'testwb3.wasm';
