...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb13.data';
    var REMOTE_PACKAGE_BASE = 'testwb13.data';
...
Module['FS_createPath']('/', 'fonts', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb13.data');

    };
    Module['addRunDependency']('datafile_testwb13.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/fonts/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "9a335cf4-89e4-4cdc-824a-c2464f67d989"});
...
var wasmBinaryFile = 'testwb13.wasm';
