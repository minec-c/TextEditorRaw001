...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb4.data';
    var REMOTE_PACKAGE_BASE = 'testwb4.data';
...
Module['FS_createPath']('/', 'assets', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb4.data');

    };
    Module['addRunDependency']('datafile_testwb4.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/assets/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "62ad2f8b-45a1-4333-a909-f775602fe6e9"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5407408,
    DYNAMIC_BASE = 5407408,
    DYNAMICTOP_PTR = 164320;
...
var wasmBinaryFile = 'testwb4.wasm';
