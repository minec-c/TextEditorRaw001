...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb10.data';
    var REMOTE_PACKAGE_BASE = 'testwb10.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb10.data');

    };
    Module['addRunDependency']('datafile_testwb10.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "543431c5-7bf2-451a-b0ca-edb59d8799a7"});
...
var wasmBinaryFile = 'testwb10.wasm';
