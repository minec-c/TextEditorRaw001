...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb11.data';
    var REMOTE_PACKAGE_BASE = 'testwb11.data';
...
Module['FS_createPath']('/', 'fonts', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb11.data');

    };
    Module['addRunDependency']('datafile_testwb11.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/fonts/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "58f43c3b-606b-4bfa-b7f9-6ba9e2dc7dc7"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5406768,
    DYNAMIC_BASE = 5406768,
    DYNAMICTOP_PTR = 163680;
...
var wasmBinaryFile = 'testwb11.wasm';
