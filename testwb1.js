...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb1.data';
    var REMOTE_PACKAGE_BASE = 'testwb1.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb1.data');

    };
    Module['addRunDependency']('datafile_testwb1.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "dd8c75a7-6d49-4287-8fff-bdec35fa2739"});
...
var wasmBinaryFile = 'testwb1.wasm';
