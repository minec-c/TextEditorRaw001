...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'testwb12.data';
    var REMOTE_PACKAGE_BASE = 'testwb12.data';
...
Module['FS_createPath']('/', 'fonts', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_testwb12.data');

    };
    Module['addRunDependency']('datafile_testwb12.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 22408, "filename": "/fonts/cffyesttfno02.otf"}], "remote_package_size": 22408, "package_uuid": "31a630b6-3819-4cfe-8896-33cbcf8b813d"});
...
var wasmBinaryFile = 'testwb12.wasm';
